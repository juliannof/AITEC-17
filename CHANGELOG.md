...
| 🔴 **VALIDACIÓN HW** | **P4: Touch GT911 — pendiente validar en hardware (2026-06-11)** | Fix aplicado: `Display.cpp` i2c_cfg `flags.enable_internal_pullup = true`. Pendiente: flashear y confirmar que GT911 inicializa sin `i2c transaction failed`. |
